...
1. The Presentation Layer (Frontend Client)
...
3. The Logic Layer (Backend Application Server)
...
4. The Storage Layer (Relational Database)
...
3.Conventional Commits: All changes must be saved using descriptive labels that describe the nature of the update.
Prefixes used: feat() for new capabilities, fix() for addressing bugs, and docs() for updates to manuals and text overviews.
